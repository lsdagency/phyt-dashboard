...
import { generateOptimisation } from "@/lib/optimise";
...
/** Generate (and store) the optimisation with Claude. Admin only. */
export async function POST(req: Request) {
  ...
  const optimisation = await generateOptimisation(data, await resolveEnv());
